...
#endif
/*
 * Reference IOCTL names as per QRD platform
...
*/
#define P61_SET_WIRED_ACCESS _IOW(PN544_MAGIC, 0x02, unsigned int)
 ...
 */
#define P61_SET_SPI_PWR    _IOW(PN544_MAGIC, 0x04, unsigned int)
