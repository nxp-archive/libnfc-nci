...
D_CFLAGS += -DNXP_NFCC_HCE_F=FALSE
...
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := libnfc-nxp-PN80S_example.conf
LOCAL_MODULE_PATH  := $(TARGET_OUT_ETC)
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES    := libnfc-nxp_RF-PN80S_example.conf
...
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := vendor/firmware
